...
function processSum(numberList, callback) {
  return callback(numberList.reduce(function (runningtotal, currentitem) {
...
function firstNamesAllCaps(runners) {
  let runnernames = [];
  runners.forEach(function (runner) {
    return runnernames.push(runner.first_name.toUpperCase());
  })
  return runnernames;
}
...
function tallyUpDonations(runners) {
  return runners.reduce(function (accumulator, runner) {
